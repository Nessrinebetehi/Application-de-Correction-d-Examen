...
def create_admin_window():
    ...
    def add_exams_window():
        ...
        ICON_PATH = os.path.join(base_path, "favicon.ico")
        add_exam_window.wm_iconbitmap(ICON_PATH)
    ...
    def add_salles_window():
        ...
        ICON_PATH = os.path.join(base_path, "favicon.ico")
        add_salle_window.wm_iconbitmap(ICON_PATH)
    ...
    def add_prof_window():
        ...
        ICON_PATH = os.path.join(base_path, "favicon.ico")
        add_prof_window.wm_iconbitmap(ICON_PATH)
    ...
    return window  # إرجاع النافذة لاستخدامها لاحقًا
